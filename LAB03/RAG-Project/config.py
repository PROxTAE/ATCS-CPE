...
SOURCE_FILE = os.path.join(DATA_DIR, "guitar_rag_dataset.txt")
SONGS_CSV_FILE = os.path.join(DATA_DIR, "List of 51m Chords for 679k Songs - Chordonomicon export 2026-08-04 14-00-16.csv")
